# Contributing
## bugs
If there is a bug please:
- Perform an update using `:Lazy`
- Restart neovim
- Re-pull/clone the config
And finally, if everything fails:
...
## Where to ask
Right now, there are not enough members to justify community management like e.g. Discord or Reddit. As long as it is not in the currently available documentation, an issue is justified.
Don't forget, anything that you don't know, is an issue with the documentation.
